...
CREATE TABLE `assets` (
  ...
  `borrow_status` enum('Available','Borrowed','Returned') DEFAULT 'Available',
...
INSERT INTO `assets` (`asset_id`, `asset_name`, `category`, `current_status`, `last_known_location`, `assigned_to`, `status`, `date_added`, `last_seen`, `borrow_status`, `borrower_name`) VALUES
(20, 'Monitor', 'IT Equipment', 'Active', 'Latitude: 12.9716, Longitude: 77.5946', 'Maki', NULL, '2025-04-10 15:24:14', NULL, 'Available', NULL),
(22, 'Mouse', 'IT Equipment', 'Active', 'aad', 'Egay', NULL, '2025-04-13 06:30:32', NULL, 'Available', NULL),
(23, 'Supra', 'Vehicles', 'In Transit', 'Latitude: 12.9716, Longitude: 77.5946', 'Maki', NULL, '2025-04-13 09:08:21', NULL, 'Available', NULL),
(24, 'Bomb', 'Lab Equipment', 'Active', 'Latitude: 12.9716, Longitude: 77.5946', 'Aleed Ibrahim', NULL, '2025-04-13 09:08:45', NULL, 'Available', NULL);
...
--
-- Dumping data for table `borrowed_assets`
--

INSERT INTO `borrowed_assets` (`id`, `asset_id`, `borrower_name`, `reason_for_borrowing`, `borrow_date`, `expected_return_date`, `actual_return_date`) VALUES
(1, 20, 'Egay', '', '2025-04-13', '2025-04-14', '2025-04-13'),
(2, 22, 'Egay', '', '2025-04-13', '2025-04-14', '2025-04-13'),
(3, 23, 'Egay', '', '2025-04-13', '2025-04-14', '2025-04-13'),
(4, 24, 'Egay', '', '2025-04-13', '2025-04-17', '2025-04-13'),
(5, 20, 'Egay', '', '2025-04-13', '2025-04-14', '2025-04-13');
...
('egay', 'Light', '30s', 'Dashboard'),
('maki', 'Light', '30s', 'Dashboard');
